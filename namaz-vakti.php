...
Class WP_Namazvakti
{
	...
	*/
	public function __construct()
	{
		...
		register_activation_hook( __FILE__, array( $this, 'register_namazvakti_plugin') );
	...
	*/
	...
	/*
		Eklentinin ilk kurulumunda çalışır ve bir daha çalışmaz! Eski güncellemelere ait veritabanı bilgilerini uçurur! Yenilerini yerine koyar!
	*/
	public function register_namazvakti_plugin()
	{
		$old_db_names = array(
			'namazvakti_sehirler',
		...
		{
			add_option ( NV_DB_DEFAULT_CITY_NAME, 'CANAKKALE' );
		}
		
		if ( get_option( NV_DB_DEFAULT_TOWN_NAME ) === FALSE )
		{
			add_option ( NV_DB_DEFAULT_TOWN_NAME, 'BIGA' );
		}
	}
